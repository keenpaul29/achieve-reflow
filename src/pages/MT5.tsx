...
import { ComputerDesktopIcon, ChartBarIcon, CogIcon, ShieldCheckIcon, CheckCircleIcon } from "@heroicons/react/24/outline";
  ...
  const features = [
    {
      ...
      description: "Over 80 built-in indicators and analytical objects for comprehensive market analysis."
    },
    {
      icon: CogIcon,
      title: "Expert Advisors (EAs)",
      description: "Automate your trading strategies with powerful algorithmic trading capabilities."
    },
    {
      icon: ShieldCheckIcon,
      title: "Multiple Order Types",
      description: "Market, limit, stop, and pending orders with advanced execution options."
    },
    {
      icon: ComputerDesktopIcon,
      title: "Multi-Asset Trading",
      description: "Trade forex, stocks, commodities, indices, and cryptocurrencies from one platform."
    }
  ];
        ...
        <section className="py-20 bg-gradient-to-br from-primary/5 via-transparent to-accent/5 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            ...
            >
              ...
              >
                The world's most advanced trading platform, designed for professional traders
                with powerful analytical tools and automated trading capabilities.
              </motion.p>
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            >
              <Card className="bg-card/50 backdrop-blur-sm border border-border/20">
                <CardContent className="p-6">
                  <Image webp="/mt5trader.webp" alt="MetaTrader 5 Interface" className="w-full rounded-lg" />
                </CardContent>
              </Card>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-4 relative">
            ...
            >
              <Card className="max-w-3xl mx-auto text-center p-12 bg-gradient-to-br from-primary/10 to-accent/10 border border-border/20 backdrop-blur-sm">
                ...
                >
                  Download MetaTrader 5 and start trading with the most powerful platform available.
                </motion.p>
                <motion.div
